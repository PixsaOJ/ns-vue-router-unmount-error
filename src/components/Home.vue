...
<template>
	<Page>
		...
		<Label text="Navigate to details, minimize app, open app, navigate back" />
		<GridLayout rows="*, auto, auto, *" class="px-4">
			...
			<Button row="2" @tap="goToDetails" class="mt-4 px-4 py-2 bg-white border-2 border-blue-400 rounded-lg"
